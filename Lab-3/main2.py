...
## TO DO: pentru fiecare dintre cele 2 foldere cu imagini(face and family) trebuie sa calculez maska de pixeli folosind fiecare metoda
    # RGB, HSV, YCbCr si le compar cu mask - urile din Ground_Truth apoi sa fac matriciele TP,FN,FP,TN si la final accuratetea.
